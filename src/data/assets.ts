...
export const SVG_TEMPLATES: Record<string, (c: string) => string> = {
    ...
    table_glass: (_c) => `<svg viewBox="0 0 100 60"><rect x="10" y="10" width="80" height="10" fill="#A2D2FF" opacity="0.6"/><rect x="15" y="20" width="5" height="35" fill="#ccc"/><rect x="80" y="20" width="5" height="35" fill="#ccc"/></svg>`,
    ...
    pixel_sword: (_c) => `<svg viewBox="0 0 100 100"><rect x="40" y="60" width="20" height="20" fill="#8D6E63"/><rect x="30" y="50" width="40" height="10" fill="#5D4037"/><rect x="40" y="10" width="20" height="40" fill="#ccc"/><path d="M40 10 L50 0 L60 10 Z" fill="#ccc"/></svg>`,
...
const COLORS = {
    wood: [
        '#8D6E63', '#6D4C41', '#A1887F', '#D7CCC8', '#5D4037', '#4E342E', '#3E2723', '#8D6E63', 
        '#BCAAA4', '#F5F5F5', '#FAFAFA', '#EFEBE9', '#D3B8AE', '#C5A094', '#B6897A', '#A87261', 
        '#995B47', '#8B442E', '#795548', '#5D4037', '#4E342E', '#3E2723', '#3E2723', '#4E342E'
    ],
    fabric: [
        '#FF9A9E', '#A1C4FD', '#C1E1C1', '#FDFD96', '#B39EB5', '#FFB347', '#FF6961',
        '#FFB7B2', '#FF9AA2', '#FFDAC1', '#E2F0CB', '#B5EAD7', '#C7CEEA', '#F44336', 
        '#E91E63', '#9C27B0', '#673AB7', '#3F51B5', '#2196F3', '#03A9F4', '#00BCD4', 
        '#009688', '#4CAF50', '#8BC34A', '#CDDC39', '#FFEB3B', '#FFC107', '#FF9800', 
        '#FF5722', '#795548', '#9E9E9E', '#607D8B', '#F06292', '#BA68C8', '#9575CD', 
        '#7986CB', '#64B5F6', '#4FC3F7', '#4DD0E1', '#4DB6AC', '#81C784', '#AED581', 
        '#DCE775', '#FFF176', '#FFD54F', '#FFB74D', '#FF8A65', '#A1887F', '#E0E0E0',
    ...
    plant: ['#2A9D8F', '#264653', '#8AB17D', '#4CAF50', '#8BC34A', '#CDDC39', '#009688', '#1B5E20', '#33691E', '#827717'],
    neutral: ['#FFFFFF', '#E0E0E0', '#333333', '#9E9E9E', '#757575', '#616161', '#424242', '#212121', '#000000']
};
